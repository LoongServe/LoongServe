...
async def send_request(
    server_addr: str,   # something like "1.2.3.4:1234"
    prompt: str,
    prompt_len: int,
    output_len: int
) -> None:
...
async def benchmark(
    ...
    async for request in get_request(input_requests, request_rate):
        ...
        task = asyncio.create_task(send_request(server_addr, prompt,
...
def main(args: argparse.Namespace):
    ...
    asyncio.run(benchmark(args.server_addr, input_requests, args.request_rate))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--server-addr", type=str, default="localhost:8000")
